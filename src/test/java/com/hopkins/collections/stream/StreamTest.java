...
public class StreamTest {
  ...
  @Test
  public void sorted_inReverse() {
    String[] names =
        Stream.of("alpha", "gamma", "beta", "delta")
            .sorted(Comparator.reversedOrder())
            .toArray(String[]::new);
    assertThat(names).asList().containsExactly("gamma", "delta", "beta", "alpha");
  }
  ...
  public void noneMatch() {
    ...
    assertThat(Stream.of("anna", "arthur").noneMatch(item -> item.endsWith("a"))).isFalse();
  }
